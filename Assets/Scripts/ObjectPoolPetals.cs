...
public class ObjectPoolPetals : MonoBehaviour {

	public static ObjectPoolPetals current;
	public GameObject pooledObject;
	public int pooledNumberOfObjects = 10; //numero de objetos que serao de fato criados
